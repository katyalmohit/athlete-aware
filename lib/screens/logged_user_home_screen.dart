...
class LoggedUserHomeScreen extends StatelessWidget {
  const LoggedUserHomeScreen({super.key});
      ...
      appBar: AppBar(
        ...
        actions: [
          ...
          PopupMenuButton<String>(
            ...
            onSelected: (value) {
              if (value == 'My Badges') {
                // Navigate to My Badges screen (replace with actual screen if available)
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => const LoggedUserHomeScreen(),
                  ),
                );
